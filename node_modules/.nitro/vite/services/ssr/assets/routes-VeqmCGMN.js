import { a as FALLBACK_STOCKS, c as articleMatchesFeed, h as timeAgo, n as DESK_ARTICLES, r as EMPTY_WIRE, t as CATEGORIES } from "./news-CHex8H38.js";
import { t as getPonsWire } from "./pons-sync-C1Sw6lew.js";
import { r as Route } from "./router-FpL2hewz.js";
import { t as PriceChart } from "./price-chart-B2AVQHKj.js";
		...
		children: [/* @__PURE__ */ jsxs("div", { children: [
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					article.ticker ? /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx("span", {
						"aria-hidden": true,
						children: "·"
					}), /* @__PURE__ */ jsx("span", {
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsx("span", {
				...
				children: /* @__PURE__ */ jsx("div", {
					...
					children: loop.map((item, index) => /* @__PURE__ */ jsxs("span", {
...
function Home() {
	...
	const articles = useMemo(() => [...wire.liveArticles, ...DESK_ARTICLES], [wire.liveArticles]);
	...
	return /* @__PURE__ */ jsxs("main", { children: [
			...
			children: [
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("span", {
						...
						children: [/* @__PURE__ */ jsx(RefreshCw, { className: `size-3.5 ${syncing ? "animate-spin" : ""}` }), "Refresh wire"]
					})]
				})
			]
		}),
		...
		/* @__PURE__ */ jsxs("section", {
			...
			children: [/* @__PURE__ */ jsxs("div", { children: [featured ? /* @__PURE__ */ jsx(ArticleCard, {
				article: featured,
				featured: true
			}) : /* @__PURE__ */ jsx("p", {
				...
				className: "mt-2",
				children: rest.slice(0, 8).map((article) => /* @__PURE__ */ jsx(ArticleCard, { article }, article.slug))
			})] }), /* @__PURE__ */ jsx("aside", {
				className: "space-y-4",
				children: bookRows.slice(0, 8).map((row) => /* @__PURE__ */ jsxs(Link, {
					to: "/article/$slug",
		...
		showStocks ? /* @__PURE__ */ jsx("section", {
			className: "mx-auto mt-8 w-full max-w-6xl px-4 sm:px-6",
			children: /* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsx("div", {
						...
						children: visibleStocks.map((row) => /* @__PURE__ */ jsxs(Link, {
							to: "/article/$slug",
							params: { slug: `live-${row.id}` },
		...
		showMarket ? /* @__PURE__ */ jsx("section", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [
						...
						/* @__PURE__ */ jsx("ol", {
							...
							children: bookRows.map((row, index) => /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsxs(Link, {
								to: "/article/$slug",
								params: { slug: `live-${row.id}` },
