...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-nowDEDbY.js");
...
var manifest = { "3cb9ff35510caf9ed68df92119ac90a339bcfa7cd8dc820daf144ffce18f56d9": {
	...
	importer: () => import("./assets/pons-sync-BMzPT8K9.js")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./assets/router-FpL2hewz.js").then((n) => n.t),
