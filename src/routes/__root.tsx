...
export const Route = createRootRoute({
  head: () => ({
    ...
    links: [
      { rel: "icon", type: "image/png", href: "/logo-pons.png?v=999" },
      { rel: "shortcut icon", type: "image/png", href: "/logo-pons.png?v=999" },
      { rel: "apple-touch-icon", href: "/logo-pons.png?v=999" },
