...
import { o as getDeskArticle } from "./news-BS2Y30v9.mjs";
...
import { n as TriangleAlert, o as Moon, r as Sun } from "../_libs/lucide-react.mjs";
...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/router-DvU-kFwj.js
...
var styles_default = "/assets/styles-ryf2jHbf.css";
...
var $$splitComponentImporter$1 = () => import("./routes-X5bKOqeZ.mjs");
var Route$1 = createFileRoute("/")({
	loader: () => getPonsWire(),
	component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
var $$splitComponentImporter = () => import("./article._slug-BnLFKH7k.mjs");
var Route = createFileRoute("/article/$slug")({
	loader: async ({ params }) => {
		...
		const live = wire.liveArticles.find((item) => item.slug === params.slug);
		if (!live) throw notFound();
		return {
			article: live,
			live: wire.liveArticles
		};
	},
