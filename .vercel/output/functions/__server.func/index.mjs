...
var grokOgIdentity = { "site": {
	...
	"card": "custom",
	"color": "8fe03a",
	"description": "News from the pons launchpad on Robinhood Chain.",
	"image": "/og.jpg"
} };
//#endregion
...
var _lazy_49RTC5 = defineLazyEventHandler(() => import("./_chunks/ssr-renderer.mjs"));
var findRoute = /* @__PURE__ */ (() => {
	const data = {
		route: "/**",
		handler: _lazy_49RTC5
	};
	return ((_m, p) => {
		return {
			data,
